...
- /Free./ When we say “free” we mean
  [[https://gnu.org/philosophy/free-sw.html][liberty, not price]]. You’re
  free to use it, modify it, share it, tinker with it, and learn
...
properly.  Some mailing lists are incompatible with and/or mangles it
(old versions of Mailman, for instance).
