...
You may subscribe to these lists [[https://lists.gnupg.org/mailman/listinfo/][via web]] or by sending an e-mail:
...
The channel =#gnupg= on =irc.libera.chat= is a place to talk about
