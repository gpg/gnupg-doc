...
* Release Notes for GnuPG
  ...
  Please read the [[https://dev.gnupg.org/source/gnupg/browse/master/NEWS][NEWS file]] 
  for a complete and up-to-date list.
  
  Note that this page is deprecated and is not updated anymore since the release of 
  GnuPG 2.1.22 in July 2017.
