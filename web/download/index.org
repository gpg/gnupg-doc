...
** Source code releases
   ...
   | [[../software/index.org][GnuPG (devel with libs)]] | {{{gnupg26_ver}}}      | {{{gnupg26_date}}}      |                         | {{{ftpopen}}}{{{ftp_loc_base}}}/gnupg/gnupg-w32-{{{gnupg24_w32_ver}}}.tar.xz{{{ftpclose}}}             | {{{ftpopen}}}{{{ftp_loc_base}}}/gnupg/gnupg-w32-{{{gnupg24_w32_ver}}}.tar.xz.sig{{{ftpclose}}}             |
   |-------------------------+------------------------+-------------------------+-------------------------+--------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------|
