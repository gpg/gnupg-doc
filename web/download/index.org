...
** Source code releases
   ...
   |--------------------------+------------------------+-------------------------+-------------------------+--------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------|
   |                          | <l>                    |                         |                     <r> |                                                                                                        |                                                                                                            |
   | [[../software/index.org][GnuPG (stable)]]           | {{{gnupg26_ver}}}      | {{{gnupg26_date}}}      |      {{{gnupg26_size}}} | {{{ftpopen}}}{{{ftp_loc_base}}}/gnupg/gnupg-{{{gnupg26_ver}}}.tar.bz2{{{ftpclose}}}                    | {{{ftpopen}}}{{{ftp_loc_base}}}/gnupg/gnupg-{{{gnupg26_ver}}}.tar.bz2.sig{{{ftpclose}}}                    |
   | [[../software/index.org][GnuPG (stable with libs)]] | {{{gnupg26_ver}}}      | {{{gnupg26_date}}}      |  {{{gnupg26_w32_ssiz}}} | {{{ftpopen}}}{{{ftp_loc_base}}}/gnupg/gnupg-w32-{{{gnupg26_w32_ver}}}.tar.xz{{{ftpclose}}}             | {{{ftpopen}}}{{{ftp_loc_base}}}/gnupg/gnupg-w32-{{{gnupg26_w32_ver}}}.tar.xz.sig{{{ftpclose}}}             |
   |--------------------------+------------------------+-------------------------+-------------------------+--------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------|
   ...
   | GnuPG 1.4 (legacy)       | {{{gnupg1_ver}}}       | {{{gnupg1_date}}}       |       {{{gnupg1_size}}} | {{{ftpopen}}}{{{ftp_loc_base}}}/gnupg/gnupg-{{{gnupg1_ver}}}.tar.bz2{{{ftpclose}}}                     | {{{ftpopen}}}{{{ftp_loc_base}}}/gnupg/gnupg-{{{gnupg1_ver}}}.tar.bz2.sig{{{ftpclose}}}                     |
   |--------------------------+------------------------+-------------------------+-------------------------+--------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------|

   All GnuPG distributions are signed.  It is wise and more secure to
   check out for their [[file:integrity_check.org][integrity]].
...
#+index: Binaries!download
   ...
   | Debian  | [[https://repos.gnupg.org/deb/gnupg/][Debian packages]]                                                                                                                                                                                  | Package repos for Debian based distributions |
   ...
   | RISC OS | [[http://www.sbellon.de/gnupg.html][home page]]                                                                                                                                                                                        | A port of GnuPG 1.4 to RISC OS               |
   |---------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------|
