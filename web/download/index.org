...
** Source code releases
   ...
   | [[../software/index.org][GnuPG (devel with libs)]] | {{{gnupg26_ver}}}      | {{{gnupg26_date}}}      |      {{{gnupg26_ssiz}}}   | {{{ftpopen}}}{{{ftp_loc_base}}}/gnupg/gnupg-w32-{{{gnupg26_w32_ver}}}.tar.xz{{{ftpclose}}}             | {{{ftpopen}}}{{{ftp_loc_base}}}/gnupg/gnupg-w32-{{{gnupg26_w32_ver}}}.tar.xz.sig{{{ftpclose}}}             |
   |-------------------------+------------------------+-------------------------+-------------------------+--------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------|
