...
definitive list in the [[http://www.gnu.org/prep/standards/html_node/OID-Allocations.html][GNU Standards document]].
  ...
  - 1.3.6.1.4.1.11591.15 :: ellipticCurves
    ...
    - 1.3.6.1.4.1.11591.15.25 :: ietf25.  This is actually X25519 as
      specified by RFC-7748.  However we used the name X25519 already
      as an alias for Curve25519 in Libgcrypt with slighly different
      semantics.
