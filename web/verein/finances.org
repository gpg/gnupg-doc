...
* Financial Overview
  ...
  Note that in general the name of a donors is not public; for larger
  donations we will however publish that name.  If you have any
...
** Bitcoin transactions
   ...
   As of 2017-09-19 we have 5.19 BTC. 21 BTC have already been
