...
* GPA - The Gnu Privacy Assistant
  ...
  The current stable version is {{{gpa_ver}}} which was released
  on {{{gpa_date}}} from the {{{gpa_branch}}} branch.  See
  the [[../../download/index.org::gpa][download]] section for the latest tarball.

** Changes in version 0.11.1 (2026-02-12)

 - Remove unused trust_item stuff to make it build with gpgme 2.x.

 - Fix a crash due to bad marshaling.  See
   https://bugs.gentoo.org/957196.

 Release-info: https://dev.gnupg.org/T7449

** Changes in version 0.11.0 (2024-12-10)
