...
#+macro: pipermail  [[https://lists.gnupg.org/pipermail/$1][{more}]]

* All News

On this page you'll find all the news of previous years in reverse
chronological order.  News for the current year are found at the [[file:index.org][main
page]].
...
See the [[file:download/index.org][download]] section on how to get this version.
...
Windows versions.  A fixed installer has been uploaded; the [[file:download/index.org::binary][download]]
...
{{{CVE(2017-7526)}}}.  See the [[file:download/index.org][download]] section on how to get this version.
...
We are pleased to announce the availability of [[file:software/libgcrypt/index.org][Libgcrypt]] version
1.7.8.   This release fixes the local side-channel attack
...
to better diagnose problems.  See the [[file:download/index.org::pinentry][download]] section on how to get
Pinentry.
...
compliant feed. Just point or paste the [[https://gnupg.org/news.en.rss][RSS file]] into
your aggregator.
...
[[file:download/index.org][download section]] . The detailed document is
...
[[file:documentation/howtos.org:GnuPG-Subkeys][{more}]]
...
We are proud to enlist on our [[file:download/mirrors.org][mirror page]]
...
The [[file:download/index.org][Download section]] now includes a link to Stefan
...
[[file:documentation/guides.org:GPG-Win][new guide]] from Brendan Kidwell
...
[[file:documentation/howtos.org:GnuPG-Keysigning-Party][GnuPG keysigning party]] .
...
[[file:documentation/guides.org:gph][The GNU Privacy Handbook]] .
...
frontend for the GNU Privacy Guard...
{{{pipermail(gpa-dev/2002-December/index.html)}}}
...
{{{pipermail(gnupg-announce/2002q4/index.html)}}}
...
designed to make access to GnuPG easier for...
{{{pipermail(gpa-dev/2002-December/index.org)}}}
...
Please see this [[file:download/release_notes.org:news-2002-10-25][list
of changes]] and then go to the [[file:download/index.org][download
instructions]] .
...
[[file:software/gpa/index.org][GPA]] 0.4.3 has been released.


** GPA pages (2001-11-15)

[[file:software/gpa/index.org][GPA pages]] reflect latest released version (gpa-0.4.2) now.


** GnuPG 1.0.6 released (2001-05-29)

See the [[file:download/release_notes.org:news-2001-05-29][release note]].
...
Add a page about [[file:software/gpgme/index.org][GPGME]] .
...
Pre-compiled version of [[file:download/index.org][GnuPG 1.0.4]] for
Windows released.
...
Put the [[file:documentation/guides.org:gph][German version]] of the GPH
online.
...
Add a [[file:documentation/faqs.org][FAQ]] .
...
Add some pages about the [[file:software/gpa/index.org][GPA]].
