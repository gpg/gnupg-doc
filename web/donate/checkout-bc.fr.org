#                                                    -*- html -*-
#+TITLE: GnuPG - Faire un don - Paiement par Bitcoins
#+STARTUP: showall
    ...
    <div class="camp-gutter container">
      <div class="row">
        <div class="col-md-7 col-md-offset-2">
          <h2>Règlement</h2>
          <p>
          Les donations en Bitcoins seront collectées par <a href="https://www.gnupg.org/verein">GnuPG e.V.</a>
          </p>

          <p>
          Veuillez envoyer votre montant en Bitcoin à
          <a href="bitcoin:1Q5ee4TcWRrphgT6UES9jZRJuwACJbEJ28"
          ><tt>1Q5ee4TcWRrphgT6UES9jZRJuwACJbEJ28</tt></a>.
          </p>
      ...
      <div class="row">
        <div class="col-sm-5 col-md-offset-2">
          <p>
            <a class="btn btn-default btn-sm" href="/donate/index.fr.html">Suivant</a>
          </p>
        </div>
      </div>
    </div>
