...
<!--custom-page-->  <!-- this disables all standard processing. -->
    ...
    <meta name="twitter:site" content="@gnupg">
    <meta name="twitter:title" content="GnuPG Donation Campaign">
    <meta name="twitter:description" content="Donate to GnuPG to ensure that GnuPG can continue to protect privacy, software updates, bitcoin wallets, and much more!">
    <meta name="twitter:image" content="https://dev.gnupg.org/u/banner1200x600">
  </head>
  <body lang="en">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
	  ...
	  <a class="navbar-right visible-xs-inline pull-right btn btn-default btn-sm navbar-btn" style="margin-right: 10px" href="/donate/donate.html" role="button">♥ Donate</a>
        </div>
	  ...
	  <ul class="nav navbar-nav navbar-right hidden-xs lang-chooser">
		...
		<li><a href="/donate/index.ja.html">
          ...
          <a class="navbar-right hidden-xs btn btn-default btn-sm navbar-btn" href="/donate/donate.html" role="button">♥ Donate</a>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
	...
	<div class="col-sm-10 col-sm-offset-1">
	  ...
	  <div class="row">
	    <div class="col-lg-10 col-lg-offset-0">
              <ul>
                <li> <a href="https://youtu.be/1OMJWpdl0DA?t=8s">Alex Abdo</a>
                  from the <a href="https://aclu.org">ACLU</a>
                <li> <a href="https://www.youtube.com/watch?v=bcNLlWqZ9d0t=10s">Andre Meister</a>
                ...
                <li> <a href="https://youtu.be/sQMj332dgIE?t=8s">Thenmozhi Soundararajan</a>
                ...
                <li> <a href="https://youtu.be/Qqg3_a72aEw?t=8s">Ksenia Ermoshina</a>,
                ...
                <li> <a href="https://youtu.be/iRuo57Hzask?t=8s">John Pershing</a>
                ...
                <li> <a href="https://youtu.be/K8-pmUyegYk?t=8s">Geoffrey King</a>,
                ...
                <li> <a href="https://youtu.be/j0Zd0wZyLP8?t=7s">Meik Michalke</a>
                ...
                <li> <a href=" https://youtu.be/MSu_FF49MtU?t=8s">Michael Stehmann</a>,
...
href="https://lists.gnupg.org/pipermail/gnupg-devel/1997-December/014131.html"
	  ...
	  <p class="text-justify">
	    The situation looked so bad that <strong>Werner was ready
            ...
            Stripe, Facebook and the Linux Foundation each committed
...
src="https://www.gnupg.org/ftp/media/openpgp.conf/2016/gnupg-team-smaller.jpg"
	  ...
	  <p class="text-justify">
	    ...
	    maintenance of GnuPG.  We also intend to use it to fund our
	  ...
	  <p class="text-justify">
	    ...
	    10 euros each month, then we intend to grow the
	...
	<div class="row goals is-table-row">
	  <div class="col-sm-10 col-sm-offset-1">
		...
		<div class="goal goal-2">
		  ...
		  <p>We want to improve documentation.  One major
		  ...
		  <div class="row">
			...
			<div class="card-text">
			  ...
			  <div class="card-meta">
			    ...
			    <div class="card-title">Director of Security</div>
		  ...
		  <div class="row">
			...
			<div class="card-text">
			  <div class="card-quote">
			    ...
			    fact that it is there is&mdash;it lets us
