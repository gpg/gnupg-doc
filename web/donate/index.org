...
<!--custom-page-->  <!-- this disables all standard processing. -->
    ...
    <meta name="twitter:title" content="GnuPG Fundraising Rally">
    <meta name="twitter:description" content="Activists, journalists, lawyers and many others rely on GnuPG to protect their communication.  Free software-based operating systems use GnuPG to verify software updates. Please donate to ensure that this critical piece of software continues to work for everyone.">
  ...
  <body lang="en">
    ...
    <div id="dailyvideo" class="camp-gutter camp-gutter-clump container">
      <div class="row">
	<div class="col-sm-10 col-sm-offset-1">
	  <h2>Video of the Day: Noah Vesely
