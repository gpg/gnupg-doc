  ...
  <body lang="en">
	...
	<div class="row">
	  <div class="col-sm-10 col-sm-offset-1">
	    <p class="lead">GnuPG needs your support to help
	      keep you safer in a surveilled world.</p>
	    <p class="text-justify">Activists, journalists, lawyers, and many others rely on
	      ...
	      system updates.</p>
            <p>To continue supporting and improving GnuPG, we, the
              ...
              raise <strong>15&#x202f;000 euros per month</strong> to fully
              fund 3 developers; our <strong>stretch goal</strong> is
              twice that, <strong>30&#x202f;000</strong> euros per month.</p>
	...
	<div class="col-sm-10 col-sm-offset-1">
	  ...
	  <p class="text-justify">
	    ...
	    class="camp-headshot pull-left"></a>, Foreign
	    Correspondent for BuzzFeed News, relates: <i>"<strong>As a
	    news organization, we're trained on using GPG.</strong>
	    "It's about your sources and what happens to them when you
	    leave the country and you publish that explosive story and
	    the government is looking for the whistleblower that
	    handed you that key piece of information."</i>  And
	    famously, GnuPG was Edward Snowden's tool of choice to
	    securely communicate with journalists about the NSA mass
	    surveillance leaks.
	  <p class="text-justify">
	  ...
	  <p class="text-justify">
	    <strong>We want to continue this work in the long
            ...
            recurring donations and not one-time donations, like last
            time.
	  <p class="text-justify">
	  ...
	  <p class="text-justify">
	    ...
	    work on the GnuK security token.  One new project that it
	    will enable is a book called "An Advanced Introduction to
	    GnuPG," which has three principle audiences: developers
	    who want to integrate GnuPG into their programs, and need
	    to understand the various concepts, the important security
	    tradeoffs, and common pitfalls; digital security trainers
	    who need to understand GnuPG to be able to make sound
	    recommendations to users; and, of course, enthusiasts.
	  <p class="text-justify">
	    ...
	    contribute to is GPG Tools, which many activists and
	    journalists rely on to secure their online communication.
	    We want to make sure that GPG integration in Apple's
	    mailer is supported as soon as a new version of macOS is
	    released.
	  <p class="text-justify">
