#                                                        -*- html -*-
#+TITLE: GnuPG - Donation Campaign 2017 (archived)
#+STARTUP: showall
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
	  ...
	  <ul class="nav navbar-header pull-right visible-xs-inline-block lang-chooser lang-chooser-xs">
	    <li class="dropdown">
	      ...
	      <a href="/donate/camp2017.de.html"
	...
	<div class="col-xs-12 col-lg-4">
	  <div class="row">
		...
		<div class="progress-bar progress-bar-striped active"
                     role="progressbar"
                     aria-valuenow="5428" A-CMPGN-RECUR-EURO=""
                     aria-valuemin="0"
                     aria-valuemax="15000" A-CMPGN-RECUR-EURO-GOAL=""
                     style="width: 36%" A-CMPGN-RECUR-PERCENT=""
                     >
		  <span class="sr-only">5428 €
                    a month</span>
		</div>
	      </div>
	    </div>
