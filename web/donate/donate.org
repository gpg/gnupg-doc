        ...
        <label for="inputType" class="col-md-2 control-label">
				...
				<div class="col-md-4">
					<select class="form-control" name="amount" id="amount">
						<option value="500" /><!--CHK_AMT500--> 500&thinsp;€</option>
						<option value="200" /><!--CHK_AMT200--> 200&thinsp;€</option>
						<option value="100" /><!--CHK_AMT100--> 100&thinsp;€</option>
						<option value="50" /><!--CHK_AMT50--> 50&thinsp;€</option>
						<option value="20" /><!--CHK_AMT20--> 20&thinsp;€</option>
						<option value="10" /><!--CHK_AMT10--> 10&thinsp;€</option>
						<option value="5" /><!--CHK_AMT5--> 5&thinsp;€</option>
					</select>
				</div>
				<div class="col-md-4">
