    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          <li><a href="/donate/index.<!--LANG-->.html">Précédent</a></li>
        </ul>
      </div><!--/.nav-collapse -->
    </div>
  </nav>
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-6">
          <div class="btn-group btn-group-xs" role="group"
            ...
            <a href="/cgi-bin/procdonate.cgi?mode=preset&s_amt=500&s_cur=eur&lang=<!--LANG-->"
               class="btn btn-default amount-btn-500">500&#x202f;€</a>
            <a href="/cgi-bin/procdonate.cgi?mode=preset&s_amt=200&s_cur=eur&lang=<!--LANG-->"
               class="btn btn-default amount-btn-200">200&#x202f;€</a>
            <a href="/cgi-bin/procdonate.cgi?mode=preset&s_amt=100&s_cur=eur&lang=<!--LANG-->"
               class="btn btn-default amount-btn-100">100&#x202f;€</a>
            <a href="/cgi-bin/procdonate.cgi?mode=preset&s_amt=50&s_cur=eur&lang=<!--LANG-->"
               class="btn btn-default amount-btn-50">50&#x202f;€</a>
            <a href="/cgi-bin/procdonate.cgi?mode=preset&s_amt=20&s_cur=eur&lang=<!--LANG-->"
               class="btn btn-default amount-btn-20">20&#x202f;€</a>
            <a href="/cgi-bin/procdonate.cgi?mode=preset&s_amt=10&s_cur=eur&lang=<!--LANG-->"
               class="btn btn-default amount-btn-10">10&#x202f;€</a>
            <a href="/cgi-bin/procdonate.cgi?mode=preset&s_amt=5&s_cur=eur&lang=<!--LANG-->"
