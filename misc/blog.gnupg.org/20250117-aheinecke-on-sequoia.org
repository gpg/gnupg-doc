...
have been sufficient. However, after collectively quitting their jobs at g10
Code, they started inventing new problems and features to justify competition
and secure funding for their work —-- even though no one seriously considered
GnuPG or OpenPGP practically vulnerable to attacks.
